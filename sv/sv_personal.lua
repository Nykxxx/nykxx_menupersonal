...
ESX.RegisterServerCallback('Nykxx:billing', function(source, cb)
...
RegisterServerEvent('Nykxx:recruter')
AddEventHandler('Nykxx:recruter', function(target, job, grade)
...
RegisterServerEvent('Nykxx:virer')
AddEventHandler('Nykxx:virer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('Nykxx:promouvoir')
AddEventHandler('Nykxx:promouvoir', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('Nykxx:destituer')
AddEventHandler('Nykxx:destituer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
